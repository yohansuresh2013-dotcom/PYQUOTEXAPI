...
class ReconnectPolicy:
    ...
    rate_limit_cooldown:
        Cooldown in seconds after broker-side HTTP 429. The client stops
        immediate reconnect/login loops and reports how long to wait.
    stop_on_rate_limit:
        When True, do not auto-reconnect after HTTP 429. This prevents the
        library from worsening a temporary IP/session rate limit.
    """
    ...
    rate_limit_cooldown: float = 75.0
