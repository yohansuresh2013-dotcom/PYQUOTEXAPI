...
from .config import load_session, normalize_host, resource_path, update_session
...
class Quotex(
    ...
    def __init__(
        ...
        Args:
            ...
            user_agent (str): Browser User-Agent. Defaults to a modern desktop browser UA.
        ...
        session = load_session(self.email, user_agent, self.host)
    ...
    def set_session(
        ...
        self.session_data = update_session(self.email, session, self.host)
